...
@ActiveProfiles({"jooq"})
public class TestContainer18nRegionRepositoryJooq extends I18nRegionRepositoryTests {
     ...
     */
    @Autowired
    public TestContainer18nRegionRepositoryJooq(TestObjectFactory testObjectFactory, I18nRegionRepository regionRepository) {
