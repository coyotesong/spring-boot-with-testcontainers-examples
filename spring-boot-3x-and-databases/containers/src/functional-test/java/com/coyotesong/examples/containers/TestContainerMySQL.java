...
public class TestContainerMySQL {
    ...
    @Container
    @ServiceConnection
    static EnhancedMySQLContainer<?> mysql = new EnhancedMySQLContainer<>();

    private final HikariDataSource dataSource;

    public TestContainerMySQL(@Autowired HikariDataSource dataSource) {
    ...
    public void performTestQuery() throws SQLException {
        try (Connection conn = dataSource.getConnection();
             ...
             ResultSet rs = stmt.executeQuery(mysql.getTestQueryString())) {
