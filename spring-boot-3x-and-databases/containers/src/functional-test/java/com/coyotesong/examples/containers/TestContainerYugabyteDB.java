...
public class TestContainerYugabyteDB {

    @Container
    @ServiceConnection
    static EnhancedYugabyteDBContainer yugabyte = new EnhancedYugabyteDBContainer();

    private final HikariDataSource dataSource;

    public TestContainerYugabyteDB(@Autowired HikariDataSource dataSource) {
    ...
    public void performTestQuery() throws SQLException {
        try (Connection conn = dataSource.getConnection();
             ...
             ResultSet rs = stmt.executeQuery(yugabyte.getTestQueryString())) {
