...
public class TestContainerClickHouse {

    @Container
    @ServiceConnection
    static EnhancedClickHouseContainer clickhouse = new EnhancedClickHouseContainer();

    private final HikariDataSource dataSource;

    public TestContainerClickHouse(@Autowired HikariDataSource dataSource) {
    ...
    public void performTestQuery() throws SQLException {
        try (Connection conn = dataSource.getConnection();
             ...
             ResultSet rs = stmt.executeQuery(clickhouse.getTestQueryString())) {
