...
public class TestContainerSQLServer {

    @Container
    @ServiceConnection
    static EnhancedSQLServerContainer<?> sqlserver = new EnhancedSQLServerContainer<>();
    ...
    public TestContainerSQLServer(@Autowired HikariDataSource dataSource) {
    ...
    public void performTestQuery() throws SQLException {
        try (Connection conn = dataSource.getConnection();
             ...
             ResultSet rs = stmt.executeQuery(sqlserver.getTestQueryString())) {
