...
public class TestContainerTimescale {

    @Container
    @ServiceConnection
    static EnhancedTimescaleContainer<?> timescale = new EnhancedTimescaleContainer<>();

    private final HikariDataSource dataSource;

    public TestContainerTimescale(@Autowired HikariDataSource dataSource) {
    ...
    public void performTestQuery() throws SQLException {
        try (Connection conn = dataSource.getConnection();
             ...
             ResultSet rs = stmt.executeQuery(timescale.getTestQueryString())) {
