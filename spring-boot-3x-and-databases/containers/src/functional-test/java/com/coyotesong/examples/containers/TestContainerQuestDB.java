...
public class TestContainerQuestDB {

    @Container
    @ServiceConnection
    static EnhancedQuestDBContainer questDB = new EnhancedQuestDBContainer();

    private final HikariDataSource dataSource;

    public TestContainerQuestDB(@Autowired HikariDataSource dataSource) {
    ...
    public void performTestQuery() throws SQLException {
        try (Connection conn = dataSource.getConnection();
             ...
             ResultSet rs = stmt.executeQuery(questDB.getTestQueryString())) {
