...
public class TestContainerPostgreSQL {
    ...
    // .withAction(FlywayMigrationAction.class);

    private final HikariDataSource dataSource;

    public TestContainerPostgreSQL(@Autowired HikariDataSource dataSource) {
    ...
    public void performTestQuery() throws SQLException {
        try (Connection conn = dataSource.getConnection();
             ...
             ResultSet rs = stmt.executeQuery(postgres.getTestQueryString())) {
