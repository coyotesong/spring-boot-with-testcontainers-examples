...
public class TestContainerMariaDB {

    @Container
    @ServiceConnection
    static EnhancedMariaDBContainer<?> mariadb = new EnhancedMariaDBContainer<>();

    private final HikariDataSource dataSource;

    public TestContainerMariaDB(@Autowired HikariDataSource dataSource) {
    ...
    public void performTestQuery() throws SQLException {
        try (Connection conn = dataSource.getConnection();
             ...
             ResultSet rs = stmt.executeQuery(mariadb.getTestQueryString())) {
