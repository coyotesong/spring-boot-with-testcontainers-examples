...
public class TestContainerOracleXE {

    @Container
    @ServiceConnection
    static EnhancedOracleXEContainer oracle = new EnhancedOracleXEContainer();

    private final HikariDataSource dataSource;

    public TestContainerOracleXE(@Autowired HikariDataSource dataSource) {
