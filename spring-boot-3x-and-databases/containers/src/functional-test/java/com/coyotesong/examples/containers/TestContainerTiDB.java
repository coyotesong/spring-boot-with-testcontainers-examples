...
public class TestContainerTiDB {

    @Container
    @ServiceConnection
    static EnhancedTiDBContainer tidb = new EnhancedTiDBContainer();

    private final HikariDataSource dataSource;

    public TestContainerTiDB(@Autowired HikariDataSource dataSource) {
    ...
    public void performTestQuery() throws SQLException {
        try (Connection conn = dataSource.getConnection();
             ...
             ResultSet rs = stmt.executeQuery(tidb.getTestQueryString())) {
