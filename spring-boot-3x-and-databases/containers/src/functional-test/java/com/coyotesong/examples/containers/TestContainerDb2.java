...
public class TestContainerDb2 {

    @Container
    @ServiceConnection
    static EnhancedDb2Container db2 = new EnhancedDb2Container();
    ...
    public TestContainerDb2(@Autowired HikariDataSource dataSource) {
    ...
    public void performTestQuery() throws SQLException {
        try (Connection conn = dataSource.getConnection();
             ...
             ResultSet rs = stmt.executeQuery(db2.getTestQueryString())) {
